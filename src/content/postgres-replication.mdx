...
summary: "Main replication concept and config in docker"
image: ""
---
...
> Heavily specialize in docker evironment. You can get full setup using docker compose [here](https://github.com/ppvan/master-slave-todos)
